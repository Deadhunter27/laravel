<nav x-data="{ open: false }" class="bg-white border-b "  style="background-color: #27005b;"> 
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('tweets.index')" :active="request()->routeIs('tweets.index')" style="color: white;">
                        {{ __('Home') }}
                    </x-nav-link>
                </div>
            </div>
